...
namespace TaskManagementApp
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            Environment.SetEnvironmentVariable("GOOGLE_APPLICATION_CREDENTIALS", "Configs/serviceAccountKey_.json");

            // Initialize FirebaseApp
            var googleCredential = GoogleCredential.FromFile("Configs/serviceAccountKey_.json");
            ...
            var json = File.ReadAllText("Configs/serviceAccountKey_.json");
